...
export const en: Translation = {
  game: {
    ...
    business: 'Business',
    computational: 'Computational resources',
    projects: 'Projects',
    paperclipsPerSecond: 'Per second',
    autoClippers: 'Clippers',
    steelWire: 'Inches',
    fundsAvailable: 'Funds available',
    unsoldInventory: 'Unsold',
    publicDemand: 'Public demand',
    paperclipCost: 'Per paperclip',
    level: 'Level',
    percent: '{{value}}\f%',
    price: '$\f{{value}}',
    cost: 'Cost',
    button: {
      makePaperclip: 'Paperclip',
      buySteelWire: 'Steel wire',
      buyAutoClippers: 'AutoClipper',
