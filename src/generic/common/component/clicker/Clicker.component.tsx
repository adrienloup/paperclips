...
import { Clicker, ClickerValue } from '@/src/generic/common/component/clicker/Clicker.type.ts';
import styles from '@/src/generic/common/component/clicker/Clicker.module.scss';
