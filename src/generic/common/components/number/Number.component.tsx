...
export const NumberComponent = ({ number, className, unit, style, notation }: Number) => {
  ...
  const formattedNumber = new Intl.NumberFormat(language === 'en' ? 'en-US' : 'fr-FR', options).format(number);
